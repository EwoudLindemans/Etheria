...
## The Five Scales
Up until now there are Five [Scales](/geography/landmark/scale.md) that penetrate the surface. But it is believed that there could be many more hidden deeply underground. A dangerous group called The [Ragged Goons](/generated/political-faction/faction/ragged-goons.md) made it their sole purpose to find and exploit new (unprotected) scales.
...
## Religions
- **Followers of [Irion](/being/deity/irion.md)**, a religious organisation that communes with the remaining spirit of the magical creature [Irion](/generated/deity/major/irion.md) that still resides in the magical [scales](/geography/landmark/scale.md). They use Batès Lamina as shrine's and will protect it whatever the cost.
