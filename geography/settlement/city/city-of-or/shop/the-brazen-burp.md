...
Nestled along the cobbled edge of **[Coalwalk Row](/geography/settlement/city/city-of-or/district/coalwalk-row.md)**, just beyond the [Heartforge](/generated/forge/heartforge.md)'s residual warmth, stands **The Brazen Burp**—a famed tavern that has withstood riots, revolutions, and at least one minor **planar misalignment**. Revered by **miners, mages, and misfits alike**, it pulses with laughter, ale, and the kind of philosophy only possible after your third tankard.
