...
At the heart of the Glimmering Ashenburrow, the Density Calibrator is an unassuming yet vital device, created by Poppy Handyleaf, that ensures the stability of this hidden city within The City of Or. A delicate blend of magical engineering and arcane craftsmanship, the Density Calibrator regulates the shifting forces of The Dense, the compressed, unstable realm that the Ashenburrow inhabits. Without it, the Ashenburrow would either collapse in on itself or explode into The City of Or, threatening the fragile balance of reality.

![the_density_calibrator.webp](/assets/images/world/the_density_calibrator.webp)
...
## Poppy's Creation
The Density Calibrator was created as a part of Poppy Handyleaf's ongoing experiments with The Dense a chaotic, compressed realm she became fascinated with. Through her research, Poppy discovered a way to manipulate the dense space around her, using a blend of arcane knowledge and mechanical ingenuity. What started as an experiment to understand the shifting forces of the realm led to the creation of the Calibrator—a device capable of stabilizing the compressed space Thus creating Ashenburrow within the City of Or .

As Poppy refined the device over time, its ability to regulate the space within the Ashenburrow grew more efficient, and it began to serve another, unintended purpose: secrecy. The Density Calibrator’s ability to subtly bend and shape space made it nearly impossible for anyone in The City of Or to detect the entrance to the Ashenburrow, keeping the city hidden within Or's walls.
